...
class Config:
    ...
    def __init__(self) -> None:
        ...
        self.cohere_api_key = os.getenv("COHERE_API_KEY", getattr(self, 'cohere_api_key', ""))
        ...
        self.openai_api_key = os.getenv("OPENAI_API_KEY", getattr(self, 'openai_api_key', ""))
        self.anthropic_api_key = os.getenv("ANTHROPIC_API_KEY", getattr(self, 'anthropic_api_key', ""))
        self.google_api_key = os.getenv("GOOGLE_API_KEY", getattr(self, 'google_api_key', ""))
